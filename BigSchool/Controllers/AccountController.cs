...
using BigSchool.Controllers.Api;
...
namespace BigSchool.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var linkedAccounts = UserManager.GetLoginsAsync(User.Identity.GetUserId());
        ...
        private async Task SignInAsync(ApplicationUser user, bool isPersistent)
        {
            ...
            object value = AuthenticationManager.SignIn(new AuthenticationProperties() { IsPersistent = isPersistent }, identity);
        }
    ...
    {
        object SignIn(AuthenticationProperties authenticationProperties, object identity);
        void SignOut(object externalCookie);
    }
